...
/**
 * This is the item provider adapter for a {@link it.disim.univaq.qml.Feature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						QmlPackage.Literals.FEATURE__NAME, true, false, false,
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Feature_abstract_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Feature_abstract_feature",
								"_UI_Feature_type"),
						QmlPackage.Literals.FEATURE__ABSTRACT, true, false, false,
	...
	protected void addHiddenPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Feature_hidden_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Feature_hidden_feature",
								"_UI_Feature_type"),
						QmlPackage.Literals.FEATURE__HIDDEN, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addMandatoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Feature_mandatory_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Feature_mandatory_feature",
								"_UI_Feature_type"),
						QmlPackage.Literals.FEATURE__MANDATORY, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Feature_group_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Feature_group_feature",
								"_UI_Feature_type"),
						QmlPackage.Literals.FEATURE__GROUP, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmlPackage.Literals.FEATURE__CHILDREN);
			childrenFeatures.add(QmlPackage.Literals.FEATURE__ATTRIBUTE);
		}
